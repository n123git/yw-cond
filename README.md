# yw-cond
A web-based W.I.P Cond analyser lib and UI for the Yo-kai Watch series with frequent updates.
...
![Formula](https://latex.codecogs.com/gif.image?\dpi{200}(\text{unique%20CTYPES}%20+%20\text{unique%20LITERAL_VALUEs}%20+%20\text{unique%20OPERATORs}%20-3)%20+%20(2%20\times%20\text{conditionCnt}))
